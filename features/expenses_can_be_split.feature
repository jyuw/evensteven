Feature: Expenses are split between all members of the group
  ...
  Scenario:
    ...
    And I should see "faraz@ca.com owes david@ca.com 500"
    And I should see "jade@ca.com owes david@ca.com 100"
    And I should see "thomas@ca.com owes jade@ca.com 250"
    And I should see "thomas@ca.com owes faraz@ca.com 150"
    And I should see "thomas@ca.com owes david@ca.com 800"
